class Bullet {
  constructor(playerAttr, canvasW, canvasH, ctx, sprite, bulletCount, UserItems) {
  ...
  setCoordinates (playerPos) {
    let x = playerPos[0];
    let y = playerPos[1];
    if (this.currentSprite.name === 'rifle' || this.currentSprite.name === 'nomad') {
  ...
  update(dt, owner) {
    ...
    if (owner === 'player') {
      ...
      switch (this.playerFace) {
        case 'left':
          this.currentUrl = this.nomadItem ? 'assets/images/bullet_horz_nomad.png' : 'assets/images/bullet_horz.png';
        ...
        case 'up':
          ...
          this.currentUrl = this.nomadItem ? 'assets/images/bullet_vert_nomad.png' : 'assets/images/bullet_vert.png';
