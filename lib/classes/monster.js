...
class Monster {
  constructor (ctx, canvasW, canvasH, sprite, gameLevel) {
    ...
    this.shift = 0;
    this.maxHP = gameLevel.bossHp;
    this.health = gameLevel.bossHp;
    this.explosion = gameLevel.explosion;
    this.children = gameLevel.children;
    this.alive = true;
